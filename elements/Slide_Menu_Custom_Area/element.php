...
\Breakdance\ElementStudio\registerElementForEditing(
    "WinuSoftCustomElements\\SlideMenuCustomArea",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class SlideMenuCustomArea extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Slide Menu Custom Area';
    }

    static function className()
    {
        return 'winusoft-slide-menu-custom-area';
    }
...
if (
  ...
  window.breakdanceMenus[menuId].refresh();
    ...
    {
        return ["type" => "container", "restrictedToBeADirectChildOf" => ['WinuSoftCustomElements\SlideMenu'],  ];
    }
